...
class PluginGroupcategoryGroupcategory extends CommonDBTM {
     ...
     * @return array
     */
    public static function getSelectedCategoriesForGroup(Entity $entity) {
    ...
    public static function getUserCategories($user_id) {
        ...
        if ($user->getFromDB($user_id)) {
            ...
            foreach ($user_groups as $entity_data) {
                $entity = new Entity();
                if ($entity->getFromDB($entity_data['id'])) {
                    $categories = self::getSelectedCategoriesForGroup($entity);
